...
message = tk.Label(window, text="Face-Recognition-Based-Attendance-Management-System"  ,fg="black"  ,width=50  ,height=3,font=('times', 30, 'italic bold underline')) 

message.place(x=200, y=20)
message = tk.Label(window, text="By-Kusum Chaudhary"  ,fg="black"  ,width=30  ,height=3,font=('times', 15, 'italic bold underline')) 
...
copyWrite.insert("insert", "Developed by kusum","", "TEAM", "superscript")
